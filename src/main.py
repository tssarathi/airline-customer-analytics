...
def main():
    if FLAG:
        ...
        customer_features_parquet_path_s3 = f"s3://{S3_BUCKET}/{CURATED_FOLDER}/customer_features/customer_features.parquet"
        ...
        run_sql_file("infra/sql/02_create_churn_pred_table.sql")

        # Create Customer Scored Table
        run_sql_file("infra/sql/03_create_customer_scored_table.sql")
